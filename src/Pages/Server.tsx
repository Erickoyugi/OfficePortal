...
const ServersDetailsContent: React.FC = () => {
  ...
  const BACKEND_API_KONG_URL = 'https://itservices.creditbank.co.ke:3001/api/servers/'; // New API endpoint
  ...
  if (apiEndpoints.length === 0) {
    return (
      <div className="bg-white bg-opacity-90 backdrop-blur-sm rounded-xl shadow-2xl p-6 md:p-8 w-full max-w-full border border-white border-opacity-30 text-gray-800">
        <h1 className="text-3xl md:text-4xl font-bold text-center mb-8">Server Details</h1>
        <p className="text-lg text-center">No specific Server found to display in this section.</p>
...
export default ServersDetailsContent;

...
// 3. Ensure user exists before trying to access .mail
   ...
   const verifyData = await verifyResponse.json();
    ...
    const status = data?.['S:Envelope']?.['S:Body']?.['ns5:ResetUserPasswordResponse']?.['Status'];
          ...
          {step === 1 && (
            <div className="space-y-6">
              <div className="text-center">
                ...
                {/* <p className="mt-2 text-sm text-slate-500">Enter your Customer ID to receive an OTP.</p> */}
              </div>
            ...
            <div className="space-y-6">
             ...
             <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-12 pr-4 py-4 bg-slate-50 border ${confirmPassword.length > 0 && confirmPassword !== newPassword ? 'border-red-400' : 'border-slate-200'} rounded-2xl focus:ring-2 focus:ring-indigo-500 outline-none`}
